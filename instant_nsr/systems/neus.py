...
class NeuSSystem(BaseSystem):
    ...
    def __init__(self, config):
        ...
        if self.config.model.if_gaussian:
            ...
            parser.add_argument("--test_iterations", nargs="+", type=int, default=[0,0+15000, 0+30000,0+100000])
            parser.add_argument("--save_iterations", nargs="+", type=int, default=[0,0+15000, 0+30000,0+100000])
